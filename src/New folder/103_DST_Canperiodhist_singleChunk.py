...
class CSVToMySQL:
    ...
    def extract_from_csv(self):
        try:
            logging.info(f"Importing data from CSV files to {self.table_name}")
            ...
            for filename in os.listdir(self.csv_dir):
                if filename.endswith(".csv"):
                    ...
                    logging.info(f"Data from {csv_file_path} imported successfully.")
...
if __name__ == "__main__":
    ...
    csv_to_mysql = CSVToMySQL(csv_dir)
